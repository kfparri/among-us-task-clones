...
def main():
    ...
    # Screen and font
    DISPLAYSURF = pygame.display.set_mode((1280, 720), pygame.FULLSCREEN) # pygame.display.set_mode((1280, 720))
    ...
    # upload text
    uploadText = FONT.render("Uploading...", True, "white")
    uploadText_rect = uploadText.get_rect(center=(640, 230))
    ...
    while True:
        ...
        if not loading_finished:
            ...
            DISPLAYSURF.blit(uploadText, uploadText_rect)
