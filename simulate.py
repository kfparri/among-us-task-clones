...
# Change log
# 8.6.2022 - Kyle Parrish
# Modified the game to make the score global and have a target score to end the game and mark the task completed
...
def checkForQuit():
    if(MAXSCORE == score):
      taskCompleteAnimation(GREEN, 50)
      terminate()
    ...
    for i in range(3): # do the flash 3 times
        for start, end, step in ((0, 255, 1), (255, 0, -1)):
            ...
            for alpha in range(start, end, animationSpeed * step): # animation loop
                ...
                taskCompleteRect.topleft = (55, WINDOWHEIGHT / 2)
